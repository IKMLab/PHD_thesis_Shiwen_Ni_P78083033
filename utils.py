...
class Datasets():
    def __init__(self, dataset_name=""):
        ...
        if (dataset_name == 'eprstmt'):
            ...
            self.train_path = r"./datasets/GLUE/SST-2/16-13/train.tsv"
            self.dev_path = r"./datasets/GLUE/SST-2/16-13/dev.tsv"
            self.test_path = r"./datasets/GLUE/SST-2/16-13/test.tsv"
            self.metric = 'Acc'
            self.label_texts = ["terrible", "great"]
            self.templates = ["[label]", "It was [label]."]
            self.patterns = [[template.replace('[label]', label) for label in self.label_texts] for template in
                             self.templates]
            ...
            self.train_path = r"./datasets/others/MR/16-shot/train.csv"
            self.dev_path = r"./datasets/others/MR/16-shot/dev.csv"
            self.test_path = r"./datasets/others/MR/16-shot/test.csv"
            self.metric = 'Acc'
            self.label_texts = ["terrible", "great"]
            self.templates = ["It was [label]", "It was [label].", "A [label] piece of work"]
            self.patterns = [[template.replace('[label]', label) for label in self.label_texts] for template in
                             self.templates]

        elif (dataset_name == 'CR'):
            self.train_path = r"./datasets/others/CR/16-shot/train.csv"
            self.dev_path = r"./datasets/others/CR/16-shot/dev.csv"
            self.test_path = r"./datasets/others/CR/16-shot/test.csv"
            self.metric = 'Acc'
            self.label_texts = ["terrible", "great"]
            self.templates = ["It was [label]", "It was [label].", "A [label] piece of work"]
            self.patterns = [[template.replace('[label]', label) for label in self.label_texts] for template in
            ...
            self.train_path = r"./datasets/others/Subj/16-shot/train.csv"
            self.dev_path = r"./datasets/others/Subj/16-shot/dev.csv"
            self.test_path = r"./datasets/others/Subj/16-shot/test.csv"
            self.metric = 'Acc'
            self.label_texts = ["subjective", "objective"]
            self.templates = ["It's [label]", "This is [label].", "A [label] piece of work"]
            self.patterns = [[template.replace('[label]', label) for label in self.label_texts] for template in
                             self.templates]

        elif (dataset_name == 'TREC'):
            self.train_path = r"./datasets/others/TREC/16-shot/train.csv"
            self.dev_path = r"./datasets/others/TREC/16-shot/dev.csv"
            self.test_path = r"./datasets/others/TREC/16-shot/test.csv"
            self.metric = 'Acc'
            self.label_texts = ["definition", "entity", "abbreviation", "people", "place", "number"]
            # self.label_texts = ['Expression', 'Entity', 'Description', 'Human', 'Location', 'Number']
            self.templates = ["[label]:", "The answer is about a [label]."]
            self.patterns = [[template.replace('[label]', label) for label in self.label_texts] for template in
                             self.templates]

        elif (dataset_name == 'SST-5'):
            self.train_path = r"./datasets/others/SST-5/16-shot/train.csv"
            self.dev_path = r"./datasets/others/SST-5/16-shot/dev.csv"
            self.test_path = r"./datasets/others/SST-5/16-shot/test.csv"
            self.metric = 'Acc'
...
class Model():
    ...
    def __init__(self, model_name=""):
        ...
        elif (model_name == 'electra-large-zh'):
            self.config_path = './models/electra_180g_large/large_discriminator_config.json'
            self.checkpoint_path = './models/electra_180g_large/electra_180g_large.ckpt'
            self.dict_path = './models/electra_180g_large/vocab.txt'
